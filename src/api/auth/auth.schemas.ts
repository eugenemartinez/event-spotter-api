...
export const updateUserProfileSchema = z
  ...
  .partial()
  .describe("Payload for updating the current user's profile information (username or email).");
...
export const apiUserResponseSchema = z
  .object({
...
export const savedEventsResponseSchema = z
  .object({
...
export const authSuccessResponseExample = {
  ...
  email: 'testuser1@example.com',
  token:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImExYjJjM2Q0LWU1ZjYtNzg5MC0xMjM0LTU2Nzg5MGFiY2RlZiIsInVzZXJuYW1lIjoidGVzdHVzZXIxIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
};
